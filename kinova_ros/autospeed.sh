...
for ((i=1;i<=$times;i++))
do
    timeout 2s rostopic pub -r 100 /j2n6s300_driver/in/cartesian_velocity kinova_msgs/PoseVelocity "{twist_linear_x: 0.0, twist_linear_y: 0.0, twist_linear_z: $forward, twist_angular_x: 0, twist_angular_y: 0.0, twist_angular_z: 0.0}"
